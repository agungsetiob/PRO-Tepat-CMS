                ...
                <div className="p-6 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            Kelola panduan utama berdasarkan kasus acara atau
                            penataan tempat keprotokolan Tanbu
                        </p>
                    </div>
                    <button
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gradient-to-r from-slate-100 to-slate-50 border-b-2 border-slate-200">
                                ...
                                <th className="py-4 px-6 text-center w-44">
                                    Aksi
                                </th>
                            </tr>
                        </thead>
                            ...
                            <div>
                                ...
                                <div className="flex items-start gap-2 mt-2">
                                    ...
                                    <span className="text-[11px] text-slate-500">
                                        Tag ini yang dicari oleh user lewat
                                        Quick Search di aplikasi mobile
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="p-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-slate-700 font-medium mb-2">
                                    Apakah Anda yakin ingin menghapus skenario
                                    ini?
                                </p>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-slate-500 mt-1">
                                            Kategori:{" "}
                                            {selectedScenario.category?.name}
                                        </p>
                            ...
                            <div className="mb-6 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                                <div className="flex items-start gap-2">
                                    ...
                                    <p className="text-xs text-amber-700">
                                        Menghapus skenario akan menghapus
                                        seluruh isi pedoman protokol/checklist
                                        di dalamnya.
                                    </p>
                                </div>
                            </div>
