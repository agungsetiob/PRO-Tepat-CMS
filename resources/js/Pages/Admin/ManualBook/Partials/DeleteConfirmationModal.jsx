                ...
                <div className="p-6">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-slate-700 font-medium mb-2">
                            Apakah Anda yakin ingin menghapus manual book ini?
                        </p>
                    ...
                    {/* Detail Manual Book yang akan dihapus */}
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 mb-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <p className="font-semibold text-slate-800">{selectedManual.title}</p>
                                <p className="text-xs text-slate-500 mt-1">
                                    File: {selectedManual.file_name} • {selectedManual.size_formatted}
                                </p>
                    ...
                    <div className="mb-6 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                        <div className="flex items-start gap-2">
                            ...
                            <p className="text-xs text-amber-700">
                                Menghapus manual book akan menghapus file fisik dari server dan tidak dapat diakses lagi oleh pengguna.
                            </p>
                        </div>
                    </div>
